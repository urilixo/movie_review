...
Movie.create!([{ title: 'Avengers: Endgame',
      ...
      Scientist Bruce Banner is exposed to gamma radiation, which has its unique side effect. During his acts of resentments, Bruce transforms into an infuriated green monster.
                 ...
                 released_on: '2003-06-27',
                 rating: 'PG-13',
                 total_gross: 245_400_000
               },
               {
                 title: 'Wonder Woman',
                 description:
...
[
  ['Avengers: Endgame', 'avengers-end-game.png'], ['Captain Marvel', 'captain-marvel.png'],
  ['Wonder Woman', 'wonder-woman.png'], ['Catwoman', 'catwoman.png'], ['Batman', 'batman.png'],
  ['Spider-Man', 'spiderman.png'], ['Superman', 'superman.png'], ['Iron Man', 'ironman.png'],
  ['Green Lantern', 'green-lantern.png'], ['Black Panther', 'black-panther.png'],
  ['Fantastic Four', 'fantastic-four.png'], ['Hulk', 'hulk.png'],
  ...
  movie.cover_image.attach(io: file, filename: file_name)
end
